 ...
 */
import { ValidatableCollection, ValidatableGeometry } from "../geometry/validation/types.mjs";
...
export declare function getGeometries({ features }: Pick<ValidatableFeatureCollection, "features">): ValidatableGeometry[];
