...
import { GeoJSON2DPosition, GeoJSON3DPosition, GeoJSONAnyPosition } from "./geometry/position.mjs";
declare const _2DOr3DBBoxSchema: z.ZodUnion<readonly [z.ZodTuple<[z.ZodNumber, z.ZodNumber, z.ZodNumber, z.ZodNumber], null>, z.ZodTuple<[z.ZodNumber, z.ZodNumber, z.ZodNumber, z.ZodNumber, z.ZodNumber, z.ZodNumber], null>]>;
 ...
 */
export type _GeoJSONBBoxGeneric<P extends GeoJSONAnyPosition> = number extends P["length"] ? _2DOr3DBBox : P extends GeoJSON3DPosition ? _2DOr3DBBox : P extends GeoJSON2DPosition ? _2DOr3DBBox : number[];
 ...
 */
export declare const GeoJSONBBoxGenericSchema: <P extends GeoJSONAnyPosition>(positionSchema: z.ZodType<P>) => GeoJSONBBoxGenericSchemaType<P>;
export type GeoJSONBBoxGeneric<P extends GeoJSONAnyPosition> = z.infer<ReturnType<typeof GeoJSONBBoxGenericSchema<P>>>;
export declare const GeoJSON2DBBoxSchema: GeoJSONBBoxGenericSchemaType<[number, number]>;
export type GeoJSON2DBBox = z.infer<typeof GeoJSON2DBBoxSchema>;
export declare const GeoJSON3DBBoxSchema: GeoJSONBBoxGenericSchemaType<[number, number, number]>;
export type GeoJSON3DBBox = z.infer<typeof GeoJSON3DBBoxSchema>;
export declare const GeoJSONBBoxSchema: GeoJSONBBoxGenericSchemaType<number[]>;
